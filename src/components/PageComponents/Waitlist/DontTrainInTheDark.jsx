  ...
  return (
    <section className="relative w-full h-[450px] bg-[#2463D8] overflow-hidden flex">
      <div className="relative z-10 max-w-[1280px] w-full mx-auto px-4 md:px-8 flex items-center justify-center">
        <div className=" max-w-[650px] md:p-8 p-0 flex flex-col gap-6">
          {/* Heading */}
          <div className="flex flex-col gap-4">
            <h2 className="font-display text-[32px] md:text-[48px] font-bold leading-[44px] md:leading-[56px] text-center text-[#FFF] uppercase">
